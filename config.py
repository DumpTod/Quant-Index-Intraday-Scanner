...
# Format: Exchange:InstrumentNameYYMMONFUT
INSTRUMENTS = {
    "NIFTY":     "NSE:NIFTY26MARFUT",
    "BANKNIFTY": "NSE:BANKNIFTY26MARFUT",
    "SENSEX":    "BSE:SENSEX26MARFUT",    # BSE exchange for SENSEX
}

# Strike intervals for options suggestion
STRIKE_INTERVALS_MAP = {
    "NIFTY":     50,
    "BANKNIFTY": 100,
    "SENSEX":    100,   # BSE SENSEX options — 100pt intervals
}
...
LOT_SIZES_MAP = {
    "NIFTY":     25,
    "BANKNIFTY": 15,
    "SENSEX":    10,    # BSE SENSEX futures lot size
}
