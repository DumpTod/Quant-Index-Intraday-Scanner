...
def token_refresh():
    ...
    Call once daily before market opens — no PIN needed.
    refresh_token lasts 15 days; re-run Colab activator every 15 days.
    """
    try:
        new_token = refresh_access_token()
        return jsonify({"status": "ok", "message": "Token refreshed successfully", "token_preview": new_token[:10] + "..."})
